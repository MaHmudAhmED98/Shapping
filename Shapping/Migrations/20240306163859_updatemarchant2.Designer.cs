...
namespace Shapping.Migrations
{
    ...
    [Migration("20240306163859_updatemarchant2")]
    partial class updatemarchant2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shapping.Model.Marchant", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MarchantId"));
            ...
            modelBuilder.Entity("Shapping.Model.SpecialPrice", b =>
                {
                    ...
                    b.Property<int?>("MerchantMarchantId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shapping.Model.Marchant", b =>
                {
                    b.HasOne("Shapping.Model.AppUser", "AppUser")
                        .WithOne("Marchant")
                        .HasForeignKey("Shapping.Model.Marchant", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Shapping.Model.SpecialPrice", b =>
                {
                    ...
                    b.HasOne("Shapping.Model.Marchant", "Merchant")
                        .WithMany("SpecialPrices")
                        .HasForeignKey("MerchantMarchantId");
